...
public class ProductVo {
    ...
    public ProductVo (Integer id,Integer categoryId,String name,String subtitle,String mainImage,String detail,BigDecimal price,Integer stock,Integer status,Integer place,String categoryName,Date createTime,Date updateTime){
        this.id = id;
